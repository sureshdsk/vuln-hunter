"""
Django settings for vuln_hunter project.
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-9sc-h@#se!+-2!(uu@a!#f&*s5k)jvonka8hv$q@b-%tuw!&-b')
...
WSGI_APPLICATION = 'vuln_hunter.wsgi.application'
